...
def train(dataloader, cnn_model, rnn_model, batch_size, labels, optimizer, epoch, ixtoword, image_dir):
    ...
    print("KeyTime |||||||||||||||||||||||||||||||")
    return count, s_cur_loss0, s_cur_loss1, w_cur_loss0, w_cur_loss1
...
if __name__ == "__main__":
    ...
    try:
        ...
        for epoch in range(start_epoch, cfg.TRAIN.MAX_EPOCH):
            ...
            count, s_cur_loss0, s_cur_loss1, w_cur_loss0, w_cur_loss1 = train(dataloader, image_encoder, text_encoder, batch_size, labels, optimizer, epoch, dataset.ixtoword, image_dir)
            print('-' * 89)
            ...
            if (epoch % 10 == 0 or epoch == cfg.TRAIN.MAX_EPOCH or epoch == cfg.TRAIN.MAX_EPOCH-1 ):
                mydrivemodel = '/content/drive/My Drive/wldl'
